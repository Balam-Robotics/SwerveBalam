...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    // Elastic Test
      ShuffleboardConstants.kDriverTab.add("Swerve State", builder -> {
        ...
        builder.addDoubleProperty(
            "Front Left Angle", () -> m_frontLeft.getState().angle.getDegrees(), null);
        builder.addDoubleProperty(
            "Front Left Velocity", () -> m_frontLeft.getState().speedMetersPerSecond, null);

        builder.addDoubleProperty(
            "Front Right Angle", () -> m_frontRight.getState().angle.getDegrees(), null);
        builder.addDoubleProperty(
            "Front Right Velocity", () -> m_frontRight.getState().speedMetersPerSecond, null);

        builder.addDoubleProperty(
            "Back Left Angle", () -> m_backLeft.getState().angle.getDegrees(), null);
        builder.addDoubleProperty(
            "Back Left Velocity", () -> m_backLeft.getState().speedMetersPerSecond, null);

        builder.addDoubleProperty(
            "Back Right Angle", () -> m_backRight.getState().angle.getDegrees(), null);
        builder.addDoubleProperty(
            "Back Right Velocity", () -> m_backRight.getState().speedMetersPerSecond, null);

        builder.addDoubleProperty(
            "Robot Angle", () -> getHeading().getRadians(), null);
      }).withSize(2, 2).withPosition(4, 0).withProperties(Map.of("rotation_unit", "radians"));
      ...
      ShuffleboardConstants.kDriverTab.add("Swerve Visualizer", builder -> {
        ...
        builder.addDoubleProperty(
            "Robot Angle", () -> getHeading().getRadians(), null);
      }).withSize(2, 2).withPosition(4, 2).withProperties(Map.of("rotation_unit", "radians"));
    ...
    gyroLayout.addDouble("Gyro Angle", () -> Units.radiansToDegrees(m_gyro.getAngle())).withWidget(BuiltInWidgets.kGyro);
    GenericEntry test = ShuffleboardConstants.kDriverTab.add("Test Boolea", false).withProperties(Map.of("true_color", "0xffe580ff","false_color", "ffe580ff")).getEntry();
